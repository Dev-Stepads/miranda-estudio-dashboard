...
INSERT INTO meta_ads_insights (date, level, campaign_id, campaign_name, adset_id, adset_name, ad_id, ad_name, spend, impressions, reach, clicks, purchases, purchase_value) VALUES
  -- Dia 1 (ontem)
  ((now() - interval '1 day')::date,  'campaign', '23847562341', 'Coleção Outono 2026', '',             NULL,                        '',             NULL,                     150.00, 4500, 3700, 75, 3, 540.00),
  ((now() - interval '1 day')::date,  'adset',    '23847562341', 'Coleção Outono 2026', '23847562342', 'Feminino 25-44 SP',         '',             NULL,                     80.00,  2500, 2000, 40, 2, 360.00),
  ((now() - interval '1 day')::date,  'adset',    '23847562341', 'Coleção Outono 2026', '23847562344', 'Feminino 18-34 Nacional',   '',             NULL,                     70.00,  2000, 1700, 35, 1, 180.00),
  ...
  -- Dia 2
  ((now() - interval '2 days')::date, 'campaign', '23847562341', 'Coleção Outono 2026', '',             NULL,                        '',             NULL,                     135.00, 4100, 3400, 68, 2, 350.00),
  ((now() - interval '2 days')::date, 'adset',    '23847562341', 'Coleção Outono 2026', '23847562342', 'Feminino 25-44 SP',         '',             NULL,                     72.00,  2250, 1850, 36, 1, 180.00),
  ((now() - interval '2 days')::date, 'adset',    '23847562341', 'Coleção Outono 2026', '23847562344', 'Feminino 18-34 Nacional',   '',             NULL,                     63.00,  1850, 1550, 32, 1, 170.00),
  ...
  -- Dia 3
  ((now() - interval '3 days')::date, 'campaign', '23847562341', 'Coleção Outono 2026', '',             NULL,                        '',             NULL,                     160.00, 4800, 3900, 82, 4, 720.00),
  ((now() - interval '3 days')::date, 'adset',    '23847562341', 'Coleção Outono 2026', '23847562342', 'Feminino 25-44 SP',         '',             NULL,                     85.00,  2600, 2100, 44, 2, 360.00),
  ((now() - interval '3 days')::date, 'adset',    '23847562341', 'Coleção Outono 2026', '23847562344', 'Feminino 18-34 Nacional',   '',             NULL,                     75.00,  2200, 1800, 38, 2, 360.00),
  ...
  -- Dia 4
  ((now() - interval '4 days')::date, 'campaign', '23847562341', 'Coleção Outono 2026', '',             NULL,                        '',             NULL,                     120.00, 3800, 3100, 60, 2, 320.00),
  ((now() - interval '4 days')::date, 'adset',    '23847562341', 'Coleção Outono 2026', '23847562342', 'Feminino 25-44 SP',         '',             NULL,                     65.00,  2100, 1700, 32, 1, 180.00),
  ((now() - interval '4 days')::date, 'adset',    '23847562341', 'Coleção Outono 2026', '23847562344', 'Feminino 18-34 Nacional',   '',             NULL,                     55.00,  1700, 1400, 28, 1, 140.00),
  ...
  -- Dia 5
  ((now() - interval '5 days')::date, 'campaign', '23847562341', 'Coleção Outono 2026', '',             NULL,                        '',             NULL,                     145.00, 4400, 3600, 72, 3, 480.00),
  ((now() - interval '5 days')::date, 'adset',    '23847562341', 'Coleção Outono 2026', '23847562342', 'Feminino 25-44 SP',         '',             NULL,                     78.00,  2400, 1950, 39, 2, 320.00),
  ((now() - interval '5 days')::date, 'adset',    '23847562341', 'Coleção Outono 2026', '23847562344', 'Feminino 18-34 Nacional',   '',             NULL,                     67.00,  2000, 1650, 33, 1, 160.00),
  ...
  -- Dia 6
  ((now() - interval '6 days')::date, 'campaign', '23847562341', 'Coleção Outono 2026', '',             NULL,                        '',             NULL,                     110.00, 3500, 2900, 55, 2, 300.00),
  ((now() - interval '6 days')::date, 'adset',    '23847562341', 'Coleção Outono 2026', '23847562342', 'Feminino 25-44 SP',         '',             NULL,                     60.00,  1900, 1550, 30, 1, 160.00),
  ((now() - interval '6 days')::date, 'adset',    '23847562341', 'Coleção Outono 2026', '23847562344', 'Feminino 18-34 Nacional',   '',             NULL,                     50.00,  1600, 1350, 25, 1, 140.00),
  ...
  -- Dia 7
  ((now() - interval '7 days')::date, 'campaign', '23847562341', 'Coleção Outono 2026', '',             NULL,                        '',             NULL,                     140.00, 4300, 3500, 70, 3, 500.00),
  ((now() - interval '7 days')::date, 'adset',    '23847562341', 'Coleção Outono 2026', '23847562342', 'Feminino 25-44 SP',         '',             NULL,                     76.00,  2350, 1900, 38, 2, 340.00),
  ((now() - interval '7 days')::date, 'adset',    '23847562341', 'Coleção Outono 2026', '23847562344', 'Feminino 18-34 Nacional',   '',             NULL,                     64.00,  1950, 1600, 32, 1, 160.00),
